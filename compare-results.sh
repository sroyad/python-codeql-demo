...
get_alert_count() {
    ...
    ALERTS_JSON=$(gh api repos/sroyad/python-codeql-demo/code-scanning/alerts 2>/dev/null)
...
echo "  Actions: https://github.com/sroyad/python-codeql-demo/actions"
echo "  Security: https://github.com/sroyad/python-codeql-demo/security/code-scanning"
